...
<current_mode>
execution — fixing table conversion bug, then adding debug mode
</current_mode>

<active_task>
TASK-001: Fix HTML table → Markdown table conversion (currently broken)
</active_task>

<parked_tasks>
TASK-002: Migrate to-markdown.js → Turndown.js (may resolve TASK-001)
...
<blockers>
None currently. Ready to investigate table bug.
</blockers>

<next_action>
Investigate current table conversion failure — get a broken example, trace through code
</next_action>
